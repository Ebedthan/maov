...
n <- 20
group <- factor(
  rep(c("Control", "Nitrogen", "Phosphorus"), each = n),
...
ggplot(df, aes(x = group, y = y, fill = group)) +
  ...
  geom_jitter(width = 0.05, size = 1.5, alpha = 0.5, aes(colour = group)) +
  scale_fill_manual(values = c("#2E86AB", "#F6AE2D", "#E84855")) +
  scale_colour_manual(values = c("#2E86AB", "#F6AE2D", "#E84855")) +
...
ggplot(df, aes(x = group, y = y, fill = group)) +
  ...
  geom_jitter(width = 0.1, size = 2, alpha = 0.6, aes(colour = group)) +
  geom_signif(
    comparisons = list(c("Control", "Nitrogen"), c("Control", "Phosphorus")),
...
ggplot(tukey_df,
       aes(
         x = estimate, y = comparison, 
         xmin = lower, xmax = upper, colour = significant)
       ) +
  geom_vline(
  ...
  geom_point(size = 4) +
  scale_colour_manual(values = c("Significant" = "#E84855", "Non-significant" = "#2E86AB")) +
  labs(
